...
void JBMusicDownloadManager::onGetSongInfoCompleted(gd::string p1,
    ...
    // CCArray* keys = GameLevelManager::sharedState()->responseToDict(p1,
    // true)->allKeys();
    // // Example of p1: 1~|~945695~|~2~|~Tennobyte - Fly
    // Away~|~3~|~51164~|~4~|~Tennobyte~|~5~|~6.47~|~6~|~~|~10~|~https%3A%2F%2Faudio.ngfiles.com%2F945000%2F945695_Tennobyte---Fly-Away.mp3%3Ff1593523523~|~7~|~~|~11~|~0~|~12~|~~|~13~|~~|~14~|~0
    ...
    //     log::info("{}",
    //     static_cast<CCString*>(keys->objectAtIndex(i))->getCString());
    // }
